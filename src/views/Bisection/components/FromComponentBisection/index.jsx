...
export default function FromComponentBisection() {
  //****************logic seccion******************
  //*consumo de useFakeRuleStore
  const { postBisection, setIsDirty } = useBisectionStore(state => ({
    postBisection: state.postBisection,
  ...
  const validationSchema = yup.object({
    ...
    eAInp: yup
      .number("Solo numeros")
      .required("campo requerido")
      .min(0.000000000000000000001, "no se admiten valores negativos")
